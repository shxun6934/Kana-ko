...
public class Kaga2ActivityHazure extends Activity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        TextView textView = findViewById(R.id.vegtable_name_incorrect);
        TextView textView_description = findViewById(R.id.description);

        ImageView yasai_syasinn = findViewById(R.id.vegetable_incorrect);

        Button button = findViewById(R.id.quiz_Backbutton);
